...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/bitcoinlite-project/bitcoinlite>";
    const std::string URL_WEBSITE = "<https://bitcoinlite.org>";
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("BitcoinLite version %s\n", FormatFullVersion());
}
