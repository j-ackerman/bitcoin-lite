...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s bitcoinlite-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  bitcoinlite-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bitcoinlite transaction") + "\n" +
              "  bitcoinlite-tx [options] -create [commands]   " + _("Create hex-encoded bitcoinlite transaction") + "\n" +
              "\n";
