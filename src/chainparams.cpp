...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.bitcoinlite.loshan.co.uk", true);
        vSeeds.emplace_back("dnsseed.thrasher.io", true);
        vSeeds.emplace_back("dnsseed.bitcoinlitetools.com", true);
        vSeeds.emplace_back("dnsseed.bitcoinlitepool.org", true);
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.bitcoinlitetools.com", true);
        vSeeds.emplace_back("seed-b.bitcoinlite.loshan.co.uk", true);
